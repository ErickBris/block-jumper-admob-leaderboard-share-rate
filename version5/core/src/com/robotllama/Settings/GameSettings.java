...
public class GameSettings {
	...
	* 
	...
	public static float menuTitleYPositionInput = 60;
	...
	public static float menuSubTitleYPositionInput = 50;
	...
	public static float menuButtonYPositionInput = 40;
	...
	* 
	...
	public static float playGameOverYPositionInput = 65;
	...
	public static float playBestScoreSubTitleYPositionInput = 55;
	...
	public static float playCurrentScoreSubTitleYPositionInput = 50;
	...
	*/
	...
	public static float getPlayScoreTitlePosX(){
		if(isNull(playScoreXPosition)){
			playScoreXPosition = (playScoreXPositionInput / 100);
		}
	...
	public static float getPlayScoreTitlePosY(){
		if(isNull(playScoreYPosition)){
			playScoreYPosition = (playScoreYPositionInput / 100);
		}
	...
	// - use title image
	public final static boolean useTitleImage = Main.getActionResolver().useTitleImage();
