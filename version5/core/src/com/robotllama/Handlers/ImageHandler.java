...
public class ImageHandler implements Disposable{
	...
	private void loadTextActors(){
		...
		currentScoreText = new CustomTextActor(GameSettings.getMainFont(), "0");
	...
	public Texture createCube(int width, int height, Color color){
		//create pulse
		Pixmap cube = new Pixmap(width, height, Pixmap.Format.RGBA8888);
		cube.setColor(color);
